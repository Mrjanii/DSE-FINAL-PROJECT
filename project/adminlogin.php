<?php
    ...
    if(!empty($Uemail) && !empty($Upwd) && !is_numeric($Uemail)){
        $query = "select * from where email = '$Uemail' limit 1";
  ...
  <body>
    <div class="banner">
        ...
        <nav id="navigation" class="navbar navbar-expand-lg fixed-top">
          ...
          <div class="nt">
          <form action=" adminPanel/index.admin.php" method="post">
            
            <h1>Login</h1>
            <div class="input-box">
                <input type="text" id="fname" name="uid"  placeholder="Username / Email" required>
